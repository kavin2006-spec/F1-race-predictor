...
const API = "https://nominatively-beechen-dewey.ngrok-free.dev";
...
const CALENDAR_2026 = [
  { round:1,  name:"Australian GP",    date:"2026-03-08", done:true  },
  { round:2,  name:"Chinese GP",       date:"2026-03-15", done:true  },
  { round:3,  name:"Japanese GP",      date:"2026-03-29", done:false },
  { round:4,  name:"Miami GP",         date:"2026-05-03", done:false },
  { round:5,  name:"Canadian GP",      date:"2026-05-24", done:false },
  { round:6,  name:"Monaco GP",        date:"2026-06-07", done:false },
  { round:7,  name:"Barcelona GP",     date:"2026-06-14", done:false },
  { round:8,  name:"Austrian GP",      date:"2026-06-28", done:false },
  { round:9,  name:"British GP",       date:"2026-07-05", done:false },
  { round:10, name:"Belgian GP",       date:"2026-07-19", done:false },
  { round:11, name:"Hungarian GP",     date:"2026-07-26", done:false },
  { round:12, name:"Dutch GP",         date:"2026-08-23", done:false },
  { round:13, name:"Italian GP",       date:"2026-09-06", done:false },
  { round:14, name:"Madrid GP",        date:"2026-09-13", done:false },
  { round:15, name:"Azerbaijan GP",    date:"2026-09-26", done:false },
  { round:16, name:"Singapore GP",     date:"2026-10-11", done:false },
  { round:17, name:"US GP",            date:"2026-10-25", done:false },
  { round:18, name:"Mexico City GP",   date:"2026-11-01", done:false },
  { round:19, name:"São Paulo GP",     date:"2026-11-08", done:false },
  { round:20, name:"Las Vegas GP",     date:"2026-11-21", done:false },
  { round:21, name:"Qatar GP",         date:"2026-11-29", done:false },
  { round:22, name:"Abu Dhabi GP",     date:"2026-12-06", done:false },
];
